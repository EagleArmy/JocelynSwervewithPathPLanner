...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs() 
        ...
        // .withKS(0.20355).withKV(2.3781).withKA(0.036765) 
    ...
    private static final Slot0Configs driveGains = new Slot0Configs()
        ...
        // .withKS(0.094252).withKV(0.11529)                                       //.withKA(0.0020805);
        .withKP(0.1).withKI(0).withKD(0)
        .withKS(0).withKV(0.124);

    //private static final Slot0Configs steerGains = new Slot0Configs()
    // Velocity
    //      .withKP(0.079991).withKI(0).withKD(0.0)
    //      .withKS(0.20355).withKV(2.3781).withKA(0.036765)  
    // Position
    //      .withKP(19.784).withKI(0).withKD(0.26626)
    //      .withKS(0.20355).withKV(2.3781).withKA(0.036765) 
    ...
    //      .withKS(0.093907).withKV(0.11427);
    // 2nd Velocity
    //      .withKP(0.025412).withKI(0).withKD(0)
    //      .withKS(0.094252).withKV(0.0.11529).withKA(0.0020805);
    // 2nd Position
    //      .withKP(10.749).withKI(0).withKD(0.10673)
    //      .withKS(0.094252).withKV(0.11529).withKA(0.0020805);
    // Generated    
    ...
    //No Rotation PID found in code (besides Auto) so just to note down: 
    //private static final Slot0Configs rotationGains = new Slot0Configs()
    // Velocity:
    //    .withKP(0.079991).withKI(0).withKD(0)
    //    .withKS(0.20355).withKV(2.3781).withKA(0.036765);
    // Position:
    //    .withKP(17.217).withKI(0).withKD(0.22908)
    //    .withKS(0.20355).withKV(2.3781).withKA(0.036765);
